        ...
        $.ajax({
            ...
            .done(clients => {
                if (typeof clients !== "undefined") {
                    ...
                    const slicedClients = parsedClients.Clients.Client.slice(
                        0,
                        count
                    );
